...
if ( !function_exists( 'cf7md_fs' ) ) {
    ...
    function cf7md_register_required_plugins()
    {
        ...
        $config = array(
            ...
            'notice_can_install_required'    => _n_noop( 'Material Design for Contact Form 7 requires the following plugin: %1$s.', 'Material Design for Contact Form 7 requires the following plugins: %1$s.', 'cf7md' ),
            'notice_can_install_recommended' => _n_noop( 'Material Design for Contact Form 7 recommends the following plugin: %1$s.', 'Material Design for Contact Form 7 recommends the following plugins: %1$s.', 'cf7md' ),
            'notice_ask_to_update'           => _n_noop( 'The following plugin needs to be updated to its latest version to ensure maximum compatibility with Material Design for Contact Form 7: %1$s.', 'The following plugins need to be updated to their latest version to ensure maximum compatibility with this Material Design for Contact Form 7: %1$s.', 'cf7md' ),
        ),
        );
