<?php exit; ?>{
    ...
    "minify.css.groups": {
        "b956c": {
            "default": {
                "include": {
                    "files": [
                        "http:\/\/doglover.in\/wp-content\/plugins\/meks-smart-social-widget\/css\/style.css?ver=1.3.3",
                        "http:\/\/doglover.in\/wp-content\/plugins\/meks-flexible-shortcodes\/css\/style.css?ver=1.3"
                    ]
                }
            }
        }
    ...
    "minify.js.groups": {
        "b956c": {
            "default": {
                "include": {
                    "files": [
                        "http:\/\/doglover.in\/wp-includes\/js\/jquery\/jquery-migrate.min.js?ver=1.4.1",
                        "http:\/\/doglover.in\/wp-includes\/js\/wp-embed.min.js?ver=4.8.1"
                    ]
                },
                "include-footer": {
                    "files": [
                        "http:\/\/doglover.in\/wp-content\/plugins\/meks-flexible-shortcodes\/js\/main.js?ver=1.3",
                        "http:\/\/doglover.in\/wp-content\/plugins\/instagram-feed\/js\/sb-instagram.min.js?ver=1.4.9"
                    ]
                },
                "include-body": {
                    "files": [
                        "http:\/\/doglover.in\/wp-content\/plugins\/contact-form-7\/includes\/js\/scripts.js?ver=4.9"
                    ]
                }
            }
        }
    ...
    "cloudflare": {
        "email": "tom@onlinemediamasters.com",
        "key": "ade3852e690ca1c59176359c95a56fd3ab0dd",
        "zone_id": "ce399ecf6453eee7b2e8296a8e6b85ba",
        "zone_name": "onlinemediamasters.com",
        "widget_cache_mins": "5",
        "pagecache": "0"
    },
